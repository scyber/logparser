...
public class ProfilingEventParser {
	...
	/*
	Pattern matcher could be moved to resources as external resource or somehow provided externally for processing even from
	api, file, etc.
	 */
    ...
    private static final Pattern PATTERN =
       ...
       public Optional<ProfilingEvent> parse(String line) {
    	...
    	try {
			...
			logger.error("Failed to parc line Time", line);
